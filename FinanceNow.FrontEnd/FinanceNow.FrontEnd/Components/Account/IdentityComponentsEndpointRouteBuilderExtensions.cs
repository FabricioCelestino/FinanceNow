...
using FinanceNow.FrontEnd.Components.Account.Pages;
using FinanceNow.FrontEnd.Components.Account.Pages.Manage;
using FinanceNow.FrontEnd.Data;
...
namespace FinanceNow.FrontEnd.Components.Account;
